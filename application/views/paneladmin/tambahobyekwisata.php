...
<div class="main-content-container container-fluid px-4">
            ...
            <div class="page-header row no-gutters py-4">
              <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
                <span class="text-uppercase page-subtitle">Obyek Wisata</span>
                <h3 class="page-title">Tambah Obyek Wisata</h3>
              </div>
            </div>
            <!-- End Page Header -->
            <div class="row">
                  ...
                  <div class="card-body">
                    <form class="add-new-post" method="POST" enctype="multipart/form-data">
                      ...
                      <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                          <label for="feLastName">Foto obyek wisaata</label>
            ...
            $(function(){
              $(document).ready(function () {
                var options = {
                    ...
                    placeholder: 'Isi deskripsi tempat wisata di sini....',
                    theme: 'snow'
                };
